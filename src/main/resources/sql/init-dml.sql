...
insert into account(id, user_id, username, password) values (1, 1, 'user', '{noop}1234');
insert into account(id, user_id, username, password) values (2, 2, 'staff', '{noop}1234');
insert into account(id, user_id, username, password) values (3, 3, 'admin', '{noop}1234');