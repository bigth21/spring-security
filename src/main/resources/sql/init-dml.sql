...
insert into user (id, username, password, enabled) values (2, 'staff', '{noop}1234', true);
insert into user (id, username, password, enabled) values (3, 'admin', '{noop}1234', true);
